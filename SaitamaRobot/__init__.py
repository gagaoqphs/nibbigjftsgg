...
log.info("[KAZUTO] Kigyo is starting. | An Eagle Union Project. | Licensed under GPLv3.")

log.info("[KAZUTO] Not affiliated to Azur Lane or Yostar in any way whatsoever.")
log.info("[KAZUTO] Project maintained by: github.com/Dank-del (t.me/dank_as_fuck)")

# if version < 3.6, stop bot.
if sys.version_info[0] < 3 or sys.version_info[1] < 7:
    log.error(
        "[KAZUTO] You MUST have a python version of at least 3.7! Multiple features depend on this. Bot quitting."
    )
    quit(1)

parser = ConfigParser()
parser.read("config.ini")
kizconfig = parser["kizconfig"]
...
class KigyoINIT:
    def __init__(self, parser):
        ...
        self.bot_name = "Kazuto" #placeholder
        self.bot_username = "Kazutosuperbot" #placeholder
...
KInit = KazutoINIT(parser=kizconfig)
