...
@connection_status
@bot_admin
@kizcmd(command='ban', pass_args=True)
@can_restrict
@user_admin
@loggable
...
@connection_status
@kizcmd(command='tban', pass_args=True)
@bot_admin
@can_restrict
@user_admin
@loggable
...
@connection_status
@kizcmd(command='kick', pass_args=True)
@bot_admin
@can_restrict
@user_admin
@loggable
...
@bot_admin
@can_restrict
@kizcmd(command='kickme', pass_args=True, filters=Filters.chat_type.groups)
...
@connection_status
@kizcmd(command='unban', pass_args=True)
@bot_admin
@can_restrict
@user_admin
@loggable
...
@connection_status
@kizcmd(command='selfunban', pass_args=True)
@bot_admin
@can_restrict
@gloggable
